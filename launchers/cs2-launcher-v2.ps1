...
# Starting processes
Start-Process -FilePath "C:\Program Files (x86)\Internet Download Manager\IDMan.exe" -WindowStyle Hidden
Start-Process -FilePath "C:\Program Files\ShareX\ShareX.exe" -WindowStyle Hidden
